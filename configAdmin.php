...
<body id="container-page-configAdmin">
    ...
    <section id="prove-product-cat-config">
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#Panel" role="tab" data-toggle="tab">Panel principal</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="col-md-3">
                  <div class="panel panel-box clearfix">
                       <div class="panel-icon pull-left bg-ground">
              <i class="glyphicon glyphicon-list"></i>
              </div>
            <div class="panel-value pull-right">
          <h2 class="margin-top"> <?php  
               $totalProd =  ejecutarSQL::consultar("SELECT COUNT(CodigoCat) AS total FROM categoria");
                while($prod=mysqli_fetch_array($totalProd)){
                  echo $prod['total'];       
                           }
           ?> </h2>
    ...
    <div class="col-md-3">
       <div class="panel panel-box clearfix">
        ...
        <div class="panel-value pull-right">
          <h2 class="margin-top"> <?php 
          $totalProd =  ejecutarSQL::consultar("SELECT COUNT(CodigoProd) AS total FROM producto");
                while($prod=mysqli_fetch_array($totalProd)){
                  echo $prod['total'];       
                           } ?> </h2>
    ...
    <div class="col-md-3">
       <div class="panel panel-box clearfix">
        ...
        <div class="panel-value pull-right">
          <h2 class="margin-top"> <?php 
          $totalProd =  ejecutarSQL::consultar("SELECT COUNT(NumPedido) AS total FROM venta");
                while($prod=mysqli_fetch_array($totalProd)){
                  echo $prod['total'];       
                           }
           ?></h2>
        ...
        <div class="panel-value pull-right">
          <h2 class="margin-top"> <?php 
           $totalProd =  ejecutarSQL::consultar("SELECT COUNT(NIT) AS total FROM cliente");
                while($prod=mysqli_fetch_array($totalProd)){
                  echo $prod['total'];       
                           }
                           ?> </h2>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <label>Precio</label>
                                <input type="number" class="form-control"  placeholder="Precio" required maxlength="20" pattern="[0-9]{1,20}" name="prod-price">
                              </div>
                              <div class="form-group">
                                <label>Modelo</label>
                              ...
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control"  placeholder="Unidades" required maxlength="20" pattern="[0-9]{1,20}" name="prod-stock">
                              </div>
                              <div class="form-group">
