        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">IXPA ONLINE</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    <p><i class="fa fa-users fa-5x"></i></p>
                    <p class="lead">
                        Al registrate podras hacer pedidos online y obtener descuentos unicos
                    </p>
                    <br>
                    <img src="assets/img/camera.png" alt="camera" class="img-responsive">
                </div>
